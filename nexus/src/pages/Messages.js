        ...
        <aside className="w-96 bg-white border-r border-gray-200">
          <div className="p-6 border-b border-gray-200">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 bg-blue-500 text-white rounded-lg font-semibold">All</button>
              <button className="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg font-semibold">Unread</button>
              <button className="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg font-semibold">Archived</button>
            </div>
          </div>
          ...
          <main className="flex-1 flex flex-col">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-600">{selectedConversation.online ? 'Online' : 'Offline'} {selectedConversation.role && `• ${selectedConversation.role}`}</p>
                  </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
              <div className="text-center mb-6">
                <span className="px-4 py-1 bg-gray-200 text-gray-600 rounded-full text-xs font-semibold">MONDAY, OCT 14</span>
              </div>
              ...
              <div className="space-y-4 max-w-4xl mx-auto">
                {messages.map((msg) => (
                  <div key={msg.id} className={`flex ${msg.isOwn ? 'justify-end' : 'justify-start'}`}>
                    ...
                    <div className={`max-w-xl ${msg.isOwn ? 'bg-blue-500 text-white' : 'bg-white text-gray-900'} rounded-2xl px-6 py-4`}>
                      ...
                      {msg.attachment && (
                        <div className="mt-3 bg-white rounded-lg p-3 flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-semibold text-gray-900">{msg.attachment.name}</p>
                            <p className="text-xs text-gray-500">{msg.attachment.size} • {msg.attachment.type}</p>
                          </div>
                      ...
                      <p className={`text-xs mt-2 ${msg.isOwn ? 'text-blue-100' : 'text-gray-500'}`}>{msg.time}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white border-t border-gray-200 p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <button className="p-2 hover:bg-gray-100 rounded font-bold text-gray-600">B</button>
                <button className="p-2 hover:bg-gray-100 rounded italic text-gray-600">I</button>
                <button className="p-2 hover:bg-gray-100 rounded">
                  <svg className="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
