      ...
      <aside className="w-64 bg-teal-900 text-white flex flex-col">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            ...
            <button onClick={() => navigate('/find-jobs')} className="w-full flex items-center gap-3 px-4 py-3 bg-teal-800 rounded-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd" />
              </svg>
              Find Jobs
            </button>
            <button onClick={() => navigate('/applications')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-teal-800 rounded-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                <path fillRule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
              </svg>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2">
                <input type="checkbox" checked={employmentTypes.fullTime} onChange={() => toggleEmploymentType('fullTime')} className="w-4 h-4 text-blue-500" />
                <span className="text-sm">Full-time</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="checkbox" checked={employmentTypes.contract} onChange={() => toggleEmploymentType('contract')} className="w-4 h-4 text-blue-500" />
                <span className="text-sm">Contract</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="checkbox" checked={employmentTypes.remote} onChange={() => toggleEmploymentType('remote')} className="w-4 h-4 text-blue-500" />
                <span className="text-sm">Remote</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="checkbox" checked={employmentTypes.partTime} onChange={() => toggleEmploymentType('partTime')} className="w-4 h-4 text-blue-500" />
                <span className="text-sm">Part-time</span>
              </label>
            </div>
          </div>

          <button className="w-full text-blue-500 font-semibold py-2">Reset All Filters</button>
        </aside>
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="px-3 py-1 bg-green-100 text-green-700 rounded text-sm font-semibold">{job.contract_type}</span>
                        {job.location?.includes('Remote') && (
                          <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded text-sm font-semibold">Remote</span>
                        )}
                      </div>
                      <div className="flex items-center justify-between text-sm text-gray-500">
                        <span>Posted 2 days ago</span>
                        <span className="text-red-500 font-semibold">4 DAYS LEFT</span>
                      </div>
                    </div>
                  </div>
          ...
          <aside className="w-96 bg-white border-l border-gray-200 p-6 overflow-y-auto">
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-2">
                  <a href="#" className="text-blue-500 font-semibold">{selectedJob.company}</a>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <p className="font-semibold">
                  {selectedJob.salary_min ? `$${Math.round(selectedJob.salary_min/1000)}k - $${Math.round(selectedJob.salary_max/1000)}k` : 'Not specified'}
                </p>
              </div>
              <div>
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Lead design end-to-end for core creator features from ideation to production.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-gray-400 mt-1">•</span>
                  <span>Design beautiful, intuitive interfaces for complex AI-driven workflows.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-gray-400 mt-1">•</span>
                  <span>Collaborate with cross-functional partners to define product strategy and roadmap.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">Figma</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">UI/UX Design</span>
            ...
            <button onClick={() => handleApply(selectedJob)} className="w-full bg-blue-500 text-white py-3 rounded-lg font-semibold hover:bg-blue-600">
              Apply Now
            </button>
          </aside>
        )}
