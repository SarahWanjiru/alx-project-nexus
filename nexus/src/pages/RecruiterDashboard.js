      ...
      <aside className="w-64 bg-gradient-to-b from-teal-800 to-teal-900 text-white flex flex-col">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <button className="w-full flex items-center gap-3 px-4 py-3 bg-teal-700 rounded-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" />
              </svg>
              Overview
            </button>
            <button onClick={() => navigate('/admin/jobs')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-teal-700 rounded-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button onClick={() => navigate('/admin/candidates')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-teal-700 rounded-lg relative">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button onClick={() => navigate('/admin/interviews')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-teal-700 rounded-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
              </svg>
              Interviews
            </button>
            <button onClick={() => navigate('/admin/messages')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-teal-700 rounded-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button onClick={() => navigate('/admin/reports')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-teal-700 rounded-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="mt-auto p-6">
          <button onClick={() => navigate('/admin/profile')} className="w-full bg-teal-600 hover:bg-teal-500 text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="text-right">
                  <p className="font-semibold">{user?.email?.split('@')[0] || 'Sarah Jenkins'}</p>
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              You have <span className="text-teal-500 font-semibold">14 new applications</span> to review for your open positions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl border-l-4 border-teal-500 p-6 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-xs font-bold">+12%</span>
                  </div>
                ...
                <div className="bg-white rounded-xl border-l-4 border-purple-500 p-6 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-xs font-bold">Next: 2PM</span>
                  </div>
                ...
                <div className="bg-white rounded-xl border-l-4 border-orange-500 p-6 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="px-3 py-1 bg-red-100 text-red-600 rounded-full text-xs font-bold">-2 days</span>
                  </div>
                  <p className="text-gray-500 text-sm mb-1">Avg. Time to Hire</p>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="text-blue-500 font-semibold hover:text-blue-600">Manage All</button>
                </div>
                    ...
                    <div key={job.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">{job.location} • Posted 3 days ago</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                  ...
                  <tbody>
                    {candidates.map((candidate) => (
                      <tr key={candidate.id} className="border-b">
                        ...
                        <td className="py-4 text-gray-600">{candidate.appliedFor}</td>
                        <td className="py-4">
                          <div className="flex items-center gap-2">
                            <div className="flex-1 bg-gray-200 rounded-full h-2 w-24">
                              <div className="bg-teal-500 h-2 rounded-full" style={{ width: `${candidate.matchScore}%` }}></div>
                            </div>
                            <span className="text-sm font-semibold text-teal-600">{candidate.matchScore}%</span>
                          </div>
                        </td>
                        <td className="py-4">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                            candidate.status === 'Interview' ? 'bg-blue-100 text-blue-600' : 'bg-green-100 text-green-600'
                          }`}>
                            {candidate.status}
                          </span>
                        </td>
                        <td className="py-4">
                          <button className="text-blue-500 font-semibold hover:text-blue-600">Review</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white">
                ...
                <p className="text-blue-100 text-sm mb-6">Promote your job posts to get 3x more qualified candidates.</p>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold mb-1">Interview with Alex Rivera</p>
                      <p className="text-sm text-gray-600">2:00 PM - 3:00 PM • Zoom</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="text-center">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold mb-1">Team Sync: Hiring Plan</p>
                      <p className="text-sm text-gray-600">4:30 PM - 5:00 PM • Room 4B</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div className="space-y-3">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700">Review design portfolio for Alex Rivera</span>
                  </label>
                  <label className="flex items-start gap-3 cursor-pointer">
                    <input type="checkbox" className="mt-1 w-4 h-4 text-blue-500" />
                    <span className="text-sm text-gray-700">Schedule second round interviews</span>
                  </label>
                  <label className="flex items-start gap-3 cursor-pointer">
                    <input type="checkbox" className="mt-1 w-4 h-4 text-blue-500" />
                    <span className="text-sm text-gray-700">Send offer letter to Marco Russo</span>
                  </label>
                </div>
              </div>
            </div>
