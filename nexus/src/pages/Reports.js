      ...
      <aside className="w-64 bg-gradient-to-b from-teal-800 to-teal-900 text-white flex flex-col">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <button onClick={() => navigate('/admin/dashboard')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-teal-700 rounded-lg">
            ...
            <button onClick={() => navigate('/admin/candidates')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-teal-700 rounded-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Deep dive into your recruitment pipeline and team performance.</p>
          </div>
            ...
            <div className="h-64 flex items-end justify-between gap-4">
              {['JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN'].map((month, i) => (
                <div key={month} className="flex-1 flex flex-col items-center">
                  <div className="w-full bg-blue-500 rounded-t" style={{height: `${(i+1)*40}px`}}></div>
            ...
            <div className="flex items-center justify-center mb-6">
              <div className="relative w-48 h-48">
                <svg className="w-full h-full" viewBox="0 0 100 100">
                  ...
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#3b82f6" strokeWidth="20" strokeDasharray="113 251" transform="rotate(-90 50 50)"/>
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#10b981" strokeWidth="20" strokeDasharray="71 251" strokeDashoffset="-113" transform="rotate(-90 50 50)"/>
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#6366f1" strokeWidth="20" strokeDasharray="50 251" strokeDashoffset="-184" transform="rotate(-90 50 50)"/>
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#8b5cf6" strokeWidth="20" strokeDasharray="25 251" strokeDashoffset="-234" transform="rotate(-90 50 50)"/>
                </svg>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">Quarterly progress tracking against hiring targets.</p>
          </div>
          <div className="h-64 flex items-end justify-between gap-8">
            {['WEEK 01', 'WEEK 02', 'WEEK 03', 'WEEK 04', 'WEEK 05', 'WEEK 06'].map((week, i) => (
              <div key={week} className="flex-1 flex flex-col items-center">
                <div className="w-full flex gap-2 items-end">
                  <div className="flex-1 bg-blue-500 rounded-t" style={{height: `${(i+1)*30}px`}}></div>
                  <div className="flex-1 bg-gray-300 rounded-t" style={{height: `${(i+1)*35}px`}}></div>
                </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold">Top Requisitions by Performance</h3>
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="py-4">
                  <span className="px-3 py-1 bg-green-100 text-green-600 rounded-full text-xs font-bold">ON TARGET</span>
                </td>
                <td className="py-4">
                  <div className="flex items-center gap-3">
              ...
              <tr className="border-b">
                ...
                <td className="py-4">
                  <span className="px-3 py-1 bg-orange-100 text-orange-600 rounded-full text-xs font-bold">AT RISK</span>
                </td>
                <td className="py-4">
                  <div className="flex items-center gap-3">
                    <div className="flex-1 bg-gray-200 rounded-full h-2">
