      ...
      <aside className="w-64 bg-teal-900 text-white flex flex-col">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <button onClick={() => navigate('/dashboard')} className="w-full flex items-center gap-3 px-4 py-3 bg-teal-800 rounded-lg">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="text-right">
                  <p className="font-semibold">{user?.email?.split('@')[0] || 'Alex Rivera'}</p>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="col-span-2 space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600">You have <span className="text-blue-500 font-semibold">3 new job matches</span> today.</p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-white p-6 rounded-xl border border-gray-200">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-green-500 text-sm font-semibold">+2 today</span>
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {loading ? (
                    ...
                    <div key={job.id} className="bg-white p-6 rounded-xl border border-gray-200">
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-xs font-semibold">{job.contract_type}</span>
                        <span className="px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-xs font-semibold">{job.category}</span>
                        {job.salary_min && (
                      ...
                      <button onClick={() => handleApply(job)} className="w-full bg-blue-500 text-white py-3 rounded-lg font-semibold hover:bg-blue-600">
                        Apply Now
                      </button>
                    </div>
                  ))}
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-4">
                        <span className="px-3 py-1 bg-orange-100 text-orange-600 rounded-full text-xs font-semibold">Interviewing</span>
                      </td>
                      <td className="py-4">
                    ...
                    <tr>
                      ...
                      <td className="py-4">
                        <span className="px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-xs font-semibold">Applied</span>
                      </td>
                      <td className="py-4">
                        <button className="text-blue-500 font-semibold">Details</button>
                      </td>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-teal-800 to-teal-900 p-6 rounded-xl text-white">
                ...
                <p className="text-teal-200 text-sm mb-4">Get noticed by top recruiters and unlock premium features.</p>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="font-semibold text-sm mb-1">Interview Invitation</p>
                        <p className="text-gray-600 text-xs mb-2">TechNode invited you for an interview for Product Designer.</p>
                  ...
                  <div>
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="font-semibold text-sm mb-1">Profile Viewed</p>
                        <p className="text-gray-600 text-xs mb-2">A recruiter from ByteApp viewed your profile.</p>
                        <p className="text-gray-400 text-xs">5 hours ago</p>
                      </div>
                    </div>
                  </div>
                </div>
                <button className="text-blue-500 font-semibold text-sm mt-4">See All Notifications</button>
              </div>
            </div>
          </div>
        </div>
